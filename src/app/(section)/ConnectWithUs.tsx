...
const ConnectWithUs = ({ }) => {
  ...
  return (
    <section
      id="connect"
      className="relative flex w-full items-center justify-center md:justify-end overflow-hidden md:pr-7 bg-[#261d14] md:pl-[370px]"
    >
      <div className="lines">
      ...
      <div className="px-4 py-12 lg:px-0 md:py-24 flex flex-col gap-12 z-40">

        <div className="flex w-full flex-col items-center justify-center lg:flex-row">

          <div className="w-full flex flex-col gap-3 justify-center items-center">
            <p className="font-jost non-italic font-light uppercase text-white text-base text-center flex gap-3 justify-center items-center">
        ...
        <div className="w-full flex flex-col md:flex-row justify-center items-center md:justify-between gap-6">
